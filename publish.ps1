...
| ForEach-Object { 
    dotnet msbuild $_.FullName -t:Build -p:Configuration=Release -p:OutputPath=..\..\artifacts\build -p:GeneratePackageOnBuild=true -p:Version=$env:Version -p:FileVersion=$fileversion -p:FileVersion=$fileversion
